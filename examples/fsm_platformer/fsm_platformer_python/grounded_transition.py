"""Grounded Transition — FALLING -> LANDING when player touches ground."""
...
class GroundedTransition(FSMTransition):
    """Fires when the player is grounded (has landed)."""
    ...
    def is_valid(self, current_state: FSMState) -> bool:
        return self.player.is_grounded
