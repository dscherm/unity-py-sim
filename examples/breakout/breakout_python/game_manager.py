...
class GameManager(MonoBehaviour):
    ...
    @staticmethod
    def _get_instance() -> GameManager | None:
    ...
    @staticmethod
    def on_brick_destroyed() -> None:
        # Check win condition — count remaining bricks
        remaining: list[GameObject] = GameObject.find_game_objects_with_tag("Brick")
    ...
    def _setup_ui(self) -> None:
        ...
        self._canvas: Canvas = canvas_go.add_component(Canvas)

        # Score text (top left)
        score_go: GameObject = GameObject("ScoreText")
        rt_score: RectTransform = score_go.add_component(RectTransform)
        ...
        self._score_text: Text = score_go.add_component(Text)
        ...
        rt_lives: RectTransform = lives_go.add_component(RectTransform)
        ...
        self._lives_text: Text = lives_go.add_component(Text)
        ...
        status_go: GameObject = GameObject("StatusText")
        rt_status: RectTransform = status_go.add_component(RectTransform)
