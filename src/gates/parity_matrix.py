...
def _check_parity_test(row: ParityRow, test_dir: Path) -> bool:
    ...
    Files containing the `# PARITY_SCAFFOLD_SKELETON` or `# PARITY_SCAFFOLD_PARKED`
    markers are excluded — those are auto-generated by tools/parity_scaffold.py and
    represent untested or out-of-scope APIs, not real parity coverage. Only once a
    skeleton has been filled in (and the marker stripped) does it count.
    """
    ...
    for test_file in test_dir.rglob("test_*.py"):
        ...
        if "PARITY_SCAFFOLD_SKELETON" in text or "PARITY_SCAFFOLD_PARKED" in text:
            continue
